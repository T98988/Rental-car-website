      ...
      <?php if(isset($succ)) {?>
        ...
        ?>
          ...
          <div class="form-group">
                <label for="exampleInputEmail1">Car Category</label>
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Car Route</label>
                <input type="email" value="<?php echo $row->Route;?>" readonly class="form-control" name="u_car_regno">
            </div>
            <div class="form-group">
